---
name: scaleway-redis
description: Safely inspect and connect to Redis on Lleverage Scaleway Kubernetes clusters using bounded read-only commands and approved helper scripts.
metadata:
  author: tvd
  version: 1.0.0
---
