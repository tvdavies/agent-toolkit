...
# A later approval supersedes an older CHANGES_REQUESTED from the same reviewer.
# Keep only each reviewer's latest submitted review before selecting blockers.
